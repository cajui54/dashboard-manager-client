  ...
  return (
    <SheetContent className="min-w-[560px] gap-10 overflow-y-auto overflow-x-hidden p-10">
      <div className="flex h-10 w-[480px] gap-x-2">
        <h3 className="h-6 w-[432px] font-serif text-2xl font-normal tracking-tighter text-zinc-900">
          Adicionar usuário
        </h3>
        <SheetClose asChild>
          <Button
          ...
          <div className="mt-10 h-[500px] w-[480px] space-y-5">
            ...
            <div className="flex h-[62px] w-[480px] gap-x-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="labelInput !w-[232px]">CPF</FormLabel>
                    <FormControl>
                      <Input
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="labelInput !w-[232px]">RG</FormLabel>
                    <FormControl>
                      <Input
